...
4. Skin drift: components hard-coding colors. Enforced by a stylelint rule (ADR-007).
5. Date math off-by-one and timezone bugs. Table-driven tests with fixed "today".
